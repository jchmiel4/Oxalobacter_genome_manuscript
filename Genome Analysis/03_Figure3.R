...
species <- c("O. aliiformigenes" ,"O. aliiformigenes", "O. formigenes", "O. formigenes", "O. formigenes", "O. formigenes", "O. paraformigenes","O. aliiformigenes", "O. aliiformigenes", "O. aliiformigenes", "O. formigenes", "O. formigenes", "O. paeniformigenes", "O. aliiformigenes", "O. formigenes", "O. formigenes", "O. formigenes", "O. formigenes", "O. aliiformigenes", "O. paraformigenes")
...
full_pcoa <- all_nog %>%
  ...
  mutate(Taxon = ifelse(Genome %in% c("ERR2013569", "HC-1", "HOxHM18", "MGYG-HGUT-01331", "OxB", "OxCC13", "OxWR1", "HOxSLD-1", "HOxSLD-2", "SSYG-15"), "O. formigenes",
                        ifelse(Genome %in% c("HOxNP-1", "HOxNP-2", "HOxNP-3", "BA1", "BA2", "Va3", "OxK"), "O. aliiformigenes",
...
legend(-1.07, 0.735, legend = c("0", "1", "2"), title = "Antibiotic reistance", fill = c("#ee8c9a", "#ED4750", "#910507"), box.lty = 0, cex = 1.15, xjust = 0, title.adj = 7.5)
